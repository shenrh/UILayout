...
public class StaticLayoutWithMaxLines {
    ...
    public static synchronized void ensureInitialized() {
        ...
        try {
            ...
            final Class<?>[] signature = new Class[] { CharSequence.class, int.class, int.class, TextPaint.class, int.class,
                    Alignment.class, textDirClass, float.class, float.class, boolean.class, TruncateAt.class, int.class, int.class };
            ...
            UILog.e(LOGTAG, "StaticLayout constructor with max lines not found.", e);
        } catch (ClassNotFoundException e) {
            UILog.e(LOGTAG, "TextDirectionHeuristic class not found.", e);
        } catch (NoSuchFieldException e) {
            UILog.e(LOGTAG, "TextDirectionHeuristics.FIRSTSTRONG_LTR not found.", e);
        } catch (IllegalAccessException e) {
            UILog.e(LOGTAG, "TextDirectionHeuristics.FIRSTSTRONG_LTR not accessible.", e);
        } finally {
            sInitialized = true;
        }
    }
    ...
    public static synchronized StaticLayout create(CharSequence source, int bufstart, int bufend, TextPaint paint, int outerWidth,
            Alignment align, float spacingMult, float spacingAdd, boolean includePad, TruncateAt ellipsize, int ellipsisWidth, int maxLines) {
        ensureInitialized();
